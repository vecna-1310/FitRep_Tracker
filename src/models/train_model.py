...
classs= class_test_prob_y.columns
ca = confusion_matrix(y_test,class_test_y,labels=classs)


# create confusion matrix for ca
plt.figure(figsize=(10, 10))
plt.imshow(ca, interpolation="nearest", cmap=plt.cm.Blues)
